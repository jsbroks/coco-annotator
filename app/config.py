...
class Config:
    ...
    AUTOANNOTATOR_MAX_WORKERS = int(os.getenv("AUTOANNOTATOR_MAX_WORKERS", 10))
    AUTOANNOTATOR_QUEUE_SIZE = int(os.getenv("AUTOANNOTATOR_QUEUE_SIZE", 32))
    AUTOANNOTATOR_MAX_MISMATCHED = int(os.getenv("AUTOANNOTATOR_MAX_MISMATCHED", 10))
    AUTOANNOTATOR_DIFF_THRESHOLD = float(os.getenv("AUTOANNOTATOR_DIFF_THRESHOLD", 0.005))
